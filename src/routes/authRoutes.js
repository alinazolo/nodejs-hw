...
import { registerUser, loginUser, logoutUser, refreshUserSession, requestResetEmail, resetPasword } from '../controllers/authController.js';
...
router.post('auth/reset-password', celebrate(resetPasswordSchema), resetPasword);
